...
export class Service extends RestService {
    ...
    search(info) {
        var endpoint = `${serviceUri}/cutting`;
        var query = '';
        ...
        if (query !== '')
        endpoint = `${serviceUri}/cutting?${query}`;
    ...
    generateExcel(info) {
        var endpoint = `${serviceUri}/cutting-download?unit=${info.unit}&dateFrom=${info.dateFrom}&dateTo=${info.dateTo}&type=${info.type}`;
        ...
        if (query !== '')
        endpoint = `${serviceUri}/cutting-download?${query}`;
        console.log(endpoint);
